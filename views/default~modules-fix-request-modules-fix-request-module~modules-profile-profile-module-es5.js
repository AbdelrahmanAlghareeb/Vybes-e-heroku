...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-fix-request-modules-fix-request-module~modules-profile-profile-module"], {
  /***/
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015StepperJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatStepHeader = /*#__PURE__*/function (_angular_cdk_stepper_2) {
      ...
      function MatStepHeader(_intl, _focusMonitor, _elementRef, changeDetectorRef) {
        ...
        _this3 = _super2.call(this, _elementRef);
        _this3._intl = _intl;
    ...
    var MatStep = /*#__PURE__*/function (_angular_cdk_stepper_3) {
      ...
      function MatStep(stepper, _errorStateMatcher, stepperOptions) {
        ...
        _this4 = _super3.call(this, stepper, stepperOptions);
    ...
    var MatStepper = /*#__PURE__*/function (_angular_cdk_stepper_4) {
      ...
      function MatStepper() {
        ...
        _this5.steps = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["QueryList"]();
        /** Event emitted when the current step is done transitioning in. */

        _this5.animationDone = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
        /** Consumer-specified template-refs to be used to override the header icons. */

        _this5._iconOverrides = {};
        /** Stream of animation `done` events when the body expands/collapses. */

        _this5._animationDone = new rxjs__WEBPACK_IMPORTED_MODULE_8__["Subject"]();
        return _this5;
      }
      ...
      _createClass(MatStepper, [{
        ...
        value: function ngAfterContentInit() {
          ...
          this._icons.forEach(function (_ref) {
            ...
            return _this6._iconOverrides[name] = templateRef;
    ...
    var MatVerticalStepper = /*#__PURE__*/function (_MatStepper2) {
      ...
      elementRef, _document) {
        ...
        _this8 = _super6.call(this, dir, changeDetectorRef, elementRef, _document);
  ...
  /*! exports provided: FixRequestService */

  /***/
  function srcAppModulesFixRequestServicesFixRequestServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FixRequestService", function () {
      return FixRequestService;
    });
    /* harmony import */
    ...
    var FixRequestService = /*#__PURE__*/function () {
      function FixRequestService(http) {
        _classCallCheck(this, FixRequestService);

        this.http = http;
      }

      _createClass(FixRequestService, [{
        key: "getAllBrands",
        value: function getAllBrands() {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl, "DeviceBrand"));
        }
      }, {
        key: "getAllModels",
        value: function getAllModels() {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl, "DeviceModel"));
        }
      }, {
        key: "getAllModelsById",
        value: function getAllModelsById(id) {
          // DeviceModel?Filtervalue[DevicebrandId]=3
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl, "DeviceModel?Filtervalue[DevicebrandId]=").concat(id));
        } // getAllModelsById(id) {
        //   return this.http.get<ApiResponse>(`${env.baseUrl}DeviceModel/${id}` );
        // }

      }, {
        key: "getAllProblems",
        value: function getAllProblems(id) {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl, "DeviceProblemClassification?FilterValue[DeviceModelId]=").concat(id));
        }
      }, {
        key: "getAllBranshes",
        value: function getAllBranshes() {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl, "Branch"));
        }
      }, {
        key: "checkAppointment",
        value: function checkAppointment(appointmentData) {
          return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl, "RepairRequest"), appointmentData);
        }
      }, {
        key: "getAllTrackRequest",
        value: function getAllTrackRequest(id) {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl, "RepairRequestInfo?FilterValue[repairRequestNumber]=").concat(id));
        }
      }, {
        key: "getAllUserRequests",
        value: function getAllUserRequests(userId) {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl, "RepairRequest?FilterValue[userId]=").concat(userId, "&PageSize=100"));
        }
      }]);
    ...
    FixRequestService.ɵfac = function FixRequestService_Factory(t) {
      return new (t || FixRequestService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };

    FixRequestService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: FixRequestService,
      factory: FixRequestService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FixRequestService, [{
...
//# sourceMappingURL=default~modules-fix-request-modules-fix-request-module~modules-profile-profile-module-es5.js.map