  ...
  function srcAppModulesProfileComponentsTrackMyorderTrackMyorderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function TrackMyorderComponent_ng_container_92_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TrackMyorderComponent_ng_container_92_Template_button_click_3_listener() {
          ...
          return ctx_r13.deleteItem(item_r11, index_r12);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TrackMyorderComponent_ng_container_92_Template_div_click_6_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);
      ...
      _createClass(TrackMyorderComponent, [{
        ...
        value: function getOrder() {
          ...
          this._profileServ.getOrderByOrderNumber(this.myForm.value.trackId).subscribe(function (data) {
            _this12.deliveryAddress = data.data.deliveryAddress;
            _this12.invoiceAddress = data.data.invoiceAddress;
            _this12.orderItem = data.data.orderItems;
          });
        }
      }, {
        key: "deleteItem",
    ...
    TrackMyorderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 93,
      vars: 16,
      consts: [[1, "track_request", "mb-5", "track_request"], [1, "p-grid", "container"], [1, "p-col-4"], [1, "container", "py-2", "my-2"], [3, "formGroup", "ngSubmit"], ["appearance", "outline"], ["formControlName", "trackId", "matInput", "", "appNumberCharacters", "", "constraint", "numbersonly", "type", "text"], [4, "ngIf"], ["mat-flat-button", "", "color", "primary"], ["labelPosition", "bottom", 4, "ngIf"], [1, "container", "col-md-8"], [1, "py-2", "my-2"], [1, "table", "text-center"], [1, "bg-light"], ["class", "border border-white", "id", "tablebody", 4, "ngFor", "ngForOf"], [1, "order_overview", 2, "width", "90%", "margin", "auto"], [1, "box-left"], [1, "delivery_info", "s_style"], [1, "_textHead"], [1, "box-right"], [1, "invoice_info", "s_style"], [1, "Check_Out_pg"], [1, "container"], [1, "Check_Out_product"], [1, "Check_Out_product_table_header"], [4, "ngFor", "ngForOf"], ["labelPosition", "bottom"], ["stepper", ""], ["matStepperIcon", "edit"], ["label", "Booked", "state", "chat", 3, "completed"], ["label", "Shipped"], ["label", "Delivered"], ["label", "Canceled"], ["id", "tablebody", 1, "border", "border-white"], [1, "Check_Out_product_box"], [1, "product_inf"], ["mat-icon-button", "", "color", "warn", "aria-label", "Example icon button with a heart icon", 3, "click"], [1, "fas", "fa-times"], [1, "img", 2, "cursor", "pointer", 3, "click"], ["alt", "Card image cap", 3, "src"]],
