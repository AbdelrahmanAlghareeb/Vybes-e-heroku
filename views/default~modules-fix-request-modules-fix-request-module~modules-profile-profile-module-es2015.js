...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FixRequestService", function() { return FixRequestService; });
...
class FixRequestService {
    ...
    getAllBrands() {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl}DeviceBrand`);
    }
    getAllModels() {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl}DeviceModel`);
    }
    getAllModelsById(id) {
        // DeviceModel?Filtervalue[DevicebrandId]=3
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl}DeviceModel?Filtervalue[DevicebrandId]=${id}`);
    }
    // getAllModelsById(id) {
    //   return this.http.get<ApiResponse>(`${env.baseUrl}DeviceModel/${id}` );
    // }
    getAllProblems(id) {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl}DeviceProblemClassification?FilterValue[DeviceModelId]=${id}`);
    }
    getAllBranshes() {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl}Branch`);
    }
    checkAppointment(appointmentData) {
        return this.http.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl}RepairRequest`, appointmentData);
    }
    getAllTrackRequest(id) {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl}RepairRequestInfo?FilterValue[repairRequestNumber]=${id}`);
    }
    getAllUserRequests(userId) {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl}RepairRequest?FilterValue[userId]=${userId}&PageSize=100`);
    }
}
FixRequestService.ɵfac = function FixRequestService_Factory(t) { return new (t || FixRequestService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
FixRequestService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: FixRequestService, factory: FixRequestService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FixRequestService, [{
...
//# sourceMappingURL=default~modules-fix-request-modules-fix-request-module~modules-profile-profile-module-es2015.js.map